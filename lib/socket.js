...
module.exports.listen = function(app, logger) {
  ...
  function resetSimulation(callback) { // for reset
    if (resetParam === 'reset') {
  ...
  function getDemo(callback) { // for not reset
    if (resetParam !== 'reset') {
  ...
  function getPaperRemaining(callback) { // for not reset
    if (resetParam !== 'reset') {
  ...
  function getCount(callback) { // for not reset
    if (resetParam !== 'reset') {
  ...
  function getLivePrinterCount(callback) { // for not reset
    if (resetParam !== 'reset') {
  ...
  function setMonthAndData(callback) { // for reset
    if (resetParam === 'reset') {
