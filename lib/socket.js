    ...
    function() {
      ...
      function startSimulation() {
        ...
        function isInternetAvailable(callback) {
          connection.status(forest, logger, function(isConnected) {
        ...
        function setInDB(callback) {
          client.select(0, function(err, res) {
            ...
            console.log('COUNT  ' + forest.count);
      ...
      socket.on('start', function() {
        ...
        function setSimulationMode(callback) {
          connection.isAvailable(forest.printerIP, function(isConnected) {
